...
package com.googlesource.gerrit.plugins.examples.restapiHelloWorldActionProject;
...
class HelloProjectHelloWorldAction
    implements UiAction<ProjectResource>,
        RestModifyView<ProjectResource, HelloProjectHelloWorldAction.Input> {
  ...
  @Inject
  HelloProjectHelloWorldAction(Provider<CurrentUser> user) {
    this.user = user;
  }
